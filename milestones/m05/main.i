...
void goToStart() {
    ...
    playSoundA(bubblegumKK, 1504224, 1);
...
void goToGame() {
    ...
    DMANow(3, bgGameBackTiles, &((charblock *)0x6000000)[0], 4832 / 2);
    DMANow(3, bgGameBackMap, &((screenblock *)0x6000000)[28], 2048 / 2);


    DMANow(3, bgGameFrontTiles, &((charblock *)0x6000000)[1], 14560 / 2);
