...
void goToGame() {
    DMANow(3, bgGameTempPal, ((unsigned short *)0x5000000), 256);
    DMANow(3, bgGameTempTiles, &((charblock *)0x6000000)[0], 416 / 2);
    DMANow(3, bgGameTempMap, &((screenblock *)0x6000000)[28], 2048 / 2);
# 157 "main.c"
    hideSprites();
    DMANow(3, shadowOAM, ((OBJ_ATTR*)(0x7000000)), 128 * 4);
    waitForVBlank();
