...
# 1 "bgPauseTemp.h" 1
# 22 "bgPauseTemp.h"
extern const unsigned short bgPauseTempTiles[224];


extern const unsigned short bgPauseTempMap[1024];


extern const unsigned short bgPauseTempPal[256];
# 47 "main.c" 2
# 1 "spritesheet.h" 1
# 21 "spritesheet.h"
...
# 1 "bgGameFront.h" 1
# 22 "bgGameFront.h"
extern const unsigned short bgGameFrontTiles[2512];
...
void initialize() {
    ...
    (*(volatile unsigned short*)0x400000A) = (0<<7) | (0<<14) | ((0)<<2) | ((28)<<8);
    (*(volatile unsigned short*)0x4000008) = (0<<7) | (1<<14) | ((1)<<2) | ((30)<<8);
...
void goToGame() {
    ...
    DMANow(3, bgGameBackPal, ((unsigned short *)0x5000000), 256);
    DMANow(3, bgGameBackTiles, &((charblock *)0x6000000)[0], 1312 / 2);
    DMANow(3, bgGameBackMap, &((screenblock *)0x6000000)[28], 2048 / 2);


    DMANow(3, bgGameFrontTiles, &((charblock *)0x6000000)[1], 5024 / 2);
    DMANow(3, bgGameFrontMap, &((screenblock *)0x6000000)[30], 4096 / 2);
...
void goToPause() {
    ...
    DMANow(3, bgPauseTempPal, ((unsigned short *)0x5000000), 256);
    DMANow(3, bgPauseTempTiles, &((charblock *)0x6000000)[0], 448 / 2);
    DMANow(3, bgPauseTempMap, &((screenblock *)0x6000000)[28], 2048 / 2);
...
void goToWin() {
    ...
    DMANow(3, bgWinTempPal, ((unsigned short *)0x5000000), 256);
    DMANow(3, bgWinTempTiles, &((charblock *)0x6000000)[0], 320 / 2);
    DMANow(3, bgWinTempMap, &((screenblock *)0x6000000)[28], 2048 / 2);
...
void goToLose() {
    ...
    DMANow(3, bgLoseTempPal, ((unsigned short *)0x5000000), 256);
    DMANow(3, bgLoseTempTiles, &((charblock *)0x6000000)[0], 384 / 2);
    DMANow(3, bgLoseTempMap, &((screenblock *)0x6000000)[28], 2048 / 2);
